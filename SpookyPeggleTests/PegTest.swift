...
//        XCTAssertEqual(peg.getCentrePoint(), circleOfCentre, "Wrong circleOfCentre")
//    }
//
//    func testGetPegType() {
//        let circleOfCentre = CGPoint(x: 10, y: 10)
...
//        let differentPegWithSameAttributes = Peg(type: pegOne.getPegType(), circleOfCentre: pegOne.getCentrePoint())
