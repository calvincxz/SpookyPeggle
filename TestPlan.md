...
* Test gestures
  ...
  * Delete level
    ...
    * There should be a confirmation UIAlert
...
* Starting the level
  ...
  * Starting ball count should be 5
...
* Test game play (when ball is in game)
  * Ball Movement
    ...
    * Ball velocity for either x or y direction is capped.

  * Ball Collision
    * Ball should collide with the sides(left and right), and with other pegs in game.
    * Ball should not collide with top
  ...
  * Peg Removal 
    ...
    * Pegs should not disappear in any other scenarios
...
* Test action buttons
  * Message for winning/losing the game
  * Score display
  * Back button
